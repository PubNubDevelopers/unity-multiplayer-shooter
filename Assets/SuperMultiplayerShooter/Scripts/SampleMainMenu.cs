...
namespace Visyde
{
    ...
    public class SampleMainMenu : MonoBehaviour
    {
        ...
        /// <summary>
        /// Event listener to handle PubNub Status events
        /// </summary>
        /// <param name="pn"></param>
        ...
        /// </summary>
        /// <param name="UserID">The UserId (Uuid) of the Player</param>
        /// <param name="IsOnline">The online status of the player</param>
